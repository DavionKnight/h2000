...
EXPORT_SYMBOL(inet_rtm_deladdr); /* add by tianzhy 2014-12-24*/
...
EXPORT_SYMBOL(inet_rtm_newaddr); /* add by tianzhy 2014-12-25*/
...
EXPORT_SYMBOL(devinet_ioctl); /* add by tianzhy 2014-12-25*/
