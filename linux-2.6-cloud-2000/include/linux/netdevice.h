...
struct net_device_ops {
	...
	int			(*ndo_set_mac_address)(struct net_device *dev,
						       void *addr);
	/* add by Zebos & tianzhy 2015-5-29*/
	int			(*ndo_ma_list_lookup)(struct net_device *dev,
						       void *addr, int alen);
	int			(*ndo_ma_list_add)(struct net_device *dev,
						       void *addr, int alen);
	int			(*ndo_ma_list_delete)(struct net_device *dev,
						       void *addr, int alen);
